...
class SceneViewController: UIViewController {
	...
	fileprivate func setupShapes() {
		...
		// Plane
		shapes.append(Plane(center: Point(x: 0, y: -37, z: 100), normal: Point(x: 0, y: 1, z: 0), material: Material(color: Color(red: 0.0, green: 0.5, blue: 0.5), shininess: 0.5, reflectivity: 0.2)))
	}
